...
class ChatScreenServe extends StatelessWidget {
  ChatScreenServe({super.key});

  final TextEditingController messageController = TextEditingController();
  final CustomerServiceController customerServiceController = Get.put(
